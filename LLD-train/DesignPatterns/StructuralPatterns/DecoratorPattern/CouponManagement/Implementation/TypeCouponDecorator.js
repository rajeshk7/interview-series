...
var TypeCouponDecorator = /** @class */ (function (_super) {
    ...
    function TypeCouponDecorator(product, discountPercentage, type) {
    ...
    TypeCouponDecorator.eligibleTypes = [0 /* ProductType.ELECTRONIC */, 1 /* ProductType.FOOD */, 2 /* ProductType.CLOTHING */];
